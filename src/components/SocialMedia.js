    ...
    return (
        <>
            <div style={{ marginTop: "4%", textAlign: "left" }}>
                ...
                <a href="#" type="button" style={{ marginLeft: "1%", backgroundColor: "#FB02C7", border: "none" }} className="btn btn-danger">
                    Instagram
                </a>
                <a href="/auth/github" type="button" style={{ marginLeft: "1%", backgroundColor: "#0A0008", border: "none" }} className="btn btn-info">
                    Github
                </a>
                <a href="#" type="button" style={{ marginLeft: "1%", backgroundColor: "#8109F9", border: "none" }} className="btn btn-danger">
                    Twitch
                </a>
            </div>
        </>
