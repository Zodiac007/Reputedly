...
export default function Model() {
    ...
    return (
        <>
            ...
            {/* <div style={{ width: "50%", backgroundColor: "#FFF", padding: "2%" }}> */}
            ...
            {!_.isEmpty(userData) ? <h1 style={{ textAlign: "left", color: "#003D83", marginTop: "5%", marginLeft: "4%" }}>Your Social Score is {chance.natural({ min: 40, max: 100 })}%</h1> : null}
            {/* </div> */}
            {/* Model */}
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <a type="button" className="btn btn-danger">Reddit</a>
                        </div>
                    </div>
                </div>
            </div>
